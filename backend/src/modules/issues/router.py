...
async def get_issue(issue_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
...
async def delete_issue(issue_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
...
async def list_comments(issue_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
...
async def delete_comment(comment_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
...
async def get_activities(issue_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
...
async def list_attachments(issue_id: UUID, current_user_id: CurrentUserID, db: DBSession):
    service = IssueService(db)
