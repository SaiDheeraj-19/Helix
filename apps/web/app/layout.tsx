...
export const meta = () => [
  { title: "Helix | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "Helix | Simple, extensible, open-source project management tool." },
  {
