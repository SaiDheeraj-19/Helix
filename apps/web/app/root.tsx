...
const APP_TITLE = "Helix | Simple, extensible, open-source project management tool.";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Helix" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://app.helix.so/" },
  { property: "og:image", content: ogImage },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Helix - Modern project management" },
  {
    name: "keywords",
    content:
      "software development, plan, ship, software, accelerate, code management, release management, project management, work item tracking, agile, scrum, kanban, collaboration",
  },
  { name: "twitter:site", content: "@helixpowers" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: ogImage },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Helix - Modern project management" },
];
