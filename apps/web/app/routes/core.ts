...
export const coreRoutes: RouteConfigEntry[] = [
  ...
  route("auth/sign-in", "routes/redirects/core/sign-in.tsx"),
  route("auth/sign-in/*", "routes/redirects/core/sign-in.tsx"),
  route("auth/signin", "routes/redirects/core/sign-in.tsx"),
  route("auth/login", "routes/redirects/core/sign-in.tsx"),
  route("auth/sign-up", "routes/redirects/core/accounts-signup.tsx"),
  route("auth/sign-up/*", "routes/redirects/core/accounts-signup.tsx"),
  route("auth/register", "routes/redirects/core/accounts-signup.tsx"),
  route("auth/*", "routes/redirects/core/sign-in.tsx"),
