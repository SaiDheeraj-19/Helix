...
const APP_TITLE = "Helix Publish | Make your Helix boards public with one-click";
const APP_DESCRIPTION = "Helix Publish is a customer feedback management tool built on top of plane.so";
